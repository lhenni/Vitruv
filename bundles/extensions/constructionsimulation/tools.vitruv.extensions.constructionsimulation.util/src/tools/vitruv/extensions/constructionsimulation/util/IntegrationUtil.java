...
public class IntegrationUtil {
    ...
    public static InternalVirtualModel createVsum(final Iterable<VitruvDomain> metamodels) {
    	...
    	return TestUtil.createVirtualModel(projectFolder, true, metamodels, Collections.emptyList(), UserInteractionFactoryImpl.getInstance().createDialogUserInteractor());
    }
